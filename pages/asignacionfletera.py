...
def render_historial_almacen(data):
    ...
    for idx, item in enumerate(data):
        ...
        with st.container():
            st.markdown('<div style="margin-bottom: 28px;">', unsafe_allow_html=True)
            ...
            with col_tarjeta:
                ...
                st.markdown(f"""
                <div style="background-color: #263238; border: 1px solid rgba(255, 255, 255, 0.05); border-left: 5px solid {color_borde}; border-radius: 6px; padding: 2px 16px; font-family: 'Inter', sans-serif; width: 100%; box-sizing: border-box; display: grid; grid-template-columns: 80px 1fr 220px 160px; align-items: center; gap: 15px; height: 52px;">
