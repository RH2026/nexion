...
with header_zone:
    ...
    if st.session_state.busqueda_activa and st.session_state.resultado_busqueda is not None:
        ...
        if tipo == "INVENTARIO":
            ...
            # RENDER 2: RESULTADO ÚNICO UNIFICADO (ESTILO IMAGEN 2 CON TIMELINE INTEGRADO, SIN BLOQUE INFERIOR)
            if total == 1:
