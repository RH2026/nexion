    ...
    if not data:
        st.markdown("""
            <div style="background-color: #212529; border: 1px solid #ff4d4d; border-radius: 6px; padding: 14px 18px; font-family: 'Inter', sans-serif; box-sizing: border-box; width: 100%;">
                ...
                <div style="font-size: 13px; color: #d1d5db; font-weight: 500; margin-bottom: 6px;">No se encontró historial de envíos para los filtros seleccionados.</div>
                <div style="font-size: 9px; color: #ffffff; font-weight: 800; letter-spacing: 1px; text-transform: uppercase; margin-top: 6px; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 6px;">[ ACCIÓN: VERIFIQUE LOS FILTROS O VALIDE COBERTURA DIRECTA EN LOGÍSTICA // 33 19 75 31 22 ]</div>
            </div>
        """, unsafe_allow_html=True)
        return
