    ...
    <body>
        <div class="w-full space-y-2">
            ...
            <div class="list-row flex items-stretch">
                <div class="w-2 shrink-0 {"bg-emerald-500" if item['estatus'] in ["EN TIEMPO", "ENVIADA EN TIEMPO"] or (item['estatus'] == "ENVIADA" and not item['numero_guia']) else ("bg-red-500" if "RETRASO" in item['estatus'] else "bg-amber-500")} shadow-[2px_0_10px_rgba(0,0,0,0.3)]"></div>
                <div class="flex flex-col md:flex-row flex-1 p-3 items-start md:items-center justify-between gap-4">
                    ...
                    <div class="w-full md:w-36 flex justify-between md:block text-right shrink-0">
                        ...
                        <div class="text-[11px] font-black uppercase {"text-emerald-400" if item['estatus'] in ["EN TIEMPO", "ENVIADA EN TIEMPO"] or (item['estatus'] == "ENVIADA" and not item['numero_guia']) else ("text-red-400" if "RETRASO" in item['estatus'] else "text-amber-400")} tracking-tighter min-h-[16px]">
