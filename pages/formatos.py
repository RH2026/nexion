...
if query:
    ...
    if not encontrado:
        # Renderizado de Error / Warning estilo Silicon Valley
        st.markdown(f"""
            <div style="background-color: #1e262c; border-radius: 8px; padding: 20px; border-left: 5px solid #ff4b4b; margin-top: 20px;">
                <div style="display: flex; align-items: center;">
                    <div style="font-size: 2rem; margin-right: 20px;">🔍</div>
                    <div>
                        <div style="color: #8899a6; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 2px;">Estado de Búsqueda</div>
                        <div style="color: #ff4b4b; font-weight: bold; font-size: 1.4rem; line-height: 1;">SIN COINCIDENCIAS</div>
                    </div>
                </div>
                <div style="margin-top: 15px; border-top: 1px solid #3d464d; padding-top: 10px;">
                    <div style="color: #8899a6; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px;">Referencia no encontrada:</div>
