...
with col_rem:
    ...
    st.markdown('<div style="background:#333F4F;color:white;text-align:center;font-weight:bold;padding:10px;border-radius:4px;letter-spacing:1px;">REMITENTE</div>', unsafe_allow_html=True)
    st.write("")
...
with col_dest:
    ...
    st.markdown('<div style="background:#288CCA;color:white;text-align:center;font-weight:bold;padding:10px;border-radius:4px;letter-spacing:1px;">DESTINATARIO / HOTEL</div>', unsafe_allow_html=True)
    st.write("")
