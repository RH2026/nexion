    ...
    with t0:
        ...
        if df_actual.empty:
            ...
            def tarjeta_kpi(titulo, valor, color="#00D4FF"):
                return f"""
                <div style="background:#263238; border:1px solid rgba(255,255,255,0.05); border-top:0px solid {color}; border-radius:10px; padding:16px 12px; text-align:center; height:100%;">
            ...
            with sub_g3:
                ...
                grafico_horizontal(costo_por_solicitante, "#508592", alto=420)
