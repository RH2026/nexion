...
def verificar_permiso_pagina(modulo, submodulo=None):
    ...
    usuario_actual = str(st.session_state.get("usuario_activo", "")).upper()
    ...
    if submodulo:
        sub_key = str(submodulo).upper().strip()
        permiso_sub = bool(permisos.get(sub_key, False))
