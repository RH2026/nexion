                ...
                if not historial.empty:
                    ...
                    st.markdown(f"""
                        <div style="display: flex; gap: 15px; margin-bottom: 25px;">
                            ...
                            <div class="kpi-ruta-card" style="flex: 1; border-left: 5px solid #A4B9C8; position: relative; overflow: hidden;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                    <span class="kpi-tag" style="font-size: 0.7rem;">🕒 TIEMPO ESTIMADO</span>
                                    <span style="font-size: 0.8rem; color: #A4B9C8;">{fletera_recomendada}</span>
                                </div>
                                
                                <div class="kpi-route-flow" style="margin: 15px 0;">
                                    <span class="city" style="font-size: 1.2rem;">GDL</span>
                                    <div style="flex-grow: 1; display: flex; flex-direction: column; align-items: center; gap: 4px;">
                                        <span style="font-size: 0.7rem; color: #A4B9C8; letter-spacing: 2px;">TRANSIT</span>
                                        <div style="width: 80%; height: 2px; background: linear-gradient(90deg, transparent, #A4B9C8, transparent);"></div>
                                    </div>
                                    <span class="city" style="font-size: 1.2rem; color: #FFFFFF;">{texto_mostrar[:12]}</span>
                                </div>
                                
                                <div style="display: flex; align-items: baseline; gap: 8px;">
                                    <span style="font-size: 2.2rem; font-weight: 900; color: #FFFFFF;">{dias_redondeados}</span>
                                    <span style="font-size: 1rem; color: #A4B9C8; font-weight: bold;">DÍAS HÁBILES</span>
                                </div>
                                
                                <div style="margin-top: 10px; font-size: 0.75rem; color: #A4B9C8; border-top: 1px solid rgba(164, 185, 200, 0.1); padding-top: 8px;">
                                     📊 Confiabilidad basada en <b>{total_viajes}</b> entregas previas.
                                </div>
                            </div>
            
                            <div class="kpi-ruta-card" style="flex: 1; border-left: 5px solid #D4AF37; background: linear-gradient(145deg, #1c2a35, #111b22);">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                    <span class="kpi-tag" style="background: #D4AF37; color: #000; font-weight: 900;">💎 COTIZACIÓN NEXION</span>
                                    <span style="font-size: 1.1rem;">📦</span>
                                </div>
            
                                <div style="margin-top: 5px;">
                                    <div style="font-size: 0.75rem; color: #A4B9C8; text-transform: uppercase; letter-spacing: 1px;">Inversión Total</div>
                                    <div style="display: flex; align-items: baseline; gap: 5px;">
                                        <span style="font-size: 2.2rem; font-weight: 900; color: #D4AF37;">${total_con_iva:,.2f}</span>
                                        <span style="font-size: 0.8rem; color: #A4B9C8;">MXN</span>
                                    </div>
                                </div>
            
                                <div style="background: rgba(0,0,0,0.2); border-radius: 8px; padding: 10px; margin-top: 10px; border: 1px solid rgba(212, 175, 55, 0.1);">
                                    <div style="display: flex; justify-content: space-between; font-size: 0.85rem; color: #E0E6ED;">
                                        <span>Cant. Cajas: <b>{num_cajas}</b></span>
                                        <span>Unitario: <b>${precio_unitario:,.2f}</b></span>
                                    </div>
                                    <div style="font-size: 0.7rem; color: #D4AF37; margin-top: 5px; text-transform: uppercase; font-weight: bold;">
                                        ✓ {leyenda_region}
                                    </div>
                                </div>
                                
                                <div style="text-align: right; margin-top: 8px; font-size: 0.65rem; color: #A4B9C8; font-style: italic;">
                                    *Precios netos incluyen 16% de IVA
                                </div>
                            </div>
