        ...
        # 3. REPORTES
            ...
            if st.session_state.menu_sub == "APQ":
                ...
                if df_a is not None:
                    ...
                    with c4:
                        st.markdown(f"<div class='metric-card'><div class='label'>Costo por Caja</div><div class='value'>${df_m['CC26']:.2f}</div><div class='meta-ind'>Target 2024: ${df_m['CC24']:.2f}</div></div>", unsafe_allow_html=True)
                    with c5:
