        ...
        # 5. HUB LOG
            ...
            if st.session_state.menu_sub == "WALLET":
                ...
                with tab_flujos:
                    ...
                    with gr_col1:
                        st.markdown("<p class='kpi-label' style='text-align:left;'><span style='color:#D9D9D9'></span> TENDENCIA DE FLUJO (MES ACTUAL)</p>", unsafe_allow_html=True)
                    ...
                    with gr_col2:
                        st.markdown("<p class='kpi-label' style='text-align:left;'><span style='color:#D9D9D9'></span> ANÁLISIS DE CONSUMO POR CATEGORÍA</p>", unsafe_allow_html=True)
                        if not df_month.empty:
